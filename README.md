...
When starting a seed that uses the Chocobot Lua script, make sure the script is running correctly (you should see the ![Triangle vert](https://raw.githubusercontent.com/Michy1212/FFA-Randomizer/refs/heads/main/images/Triangle%20vert.png) logo).
